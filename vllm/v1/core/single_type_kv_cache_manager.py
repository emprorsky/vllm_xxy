...
class SingleTypeKVCacheManager(ABC):
    ...
    def allocate_external_computed_blocks(
        ...
        Args:
            ...
            retention_hint: Optional allocation-scoped hint of block IDs to
                retain when possible while selecting free pages.
        """
        num_total_computed_tokens = (
            num_local_computed_tokens + num_external_computed_tokens
        )
    ...
    def allocate_new_blocks(
        ...
        if request_id in self._partial_hit_reqs:
            ...
            cow_block = self.block_pool.get_new_blocks(1, retention_hint)[0]
        ...
        if num_new_blocks <= 0:
            ...
            new_blocks = self.block_pool.get_new_blocks(num_new_blocks, retention_hint)
    ...
    def allocate_new_blocks(
        ...
        if self.mamba_cache_mode != "align":
            ...
            return super().allocate_new_blocks(
                request_id, num_tokens, num_tokens_main_model, retention_hint
            )
        else:
            # We don't allocate blocks for lookahead tokens in align mode, because if
            # x * block_size tokens are scheduled, num_tokens is

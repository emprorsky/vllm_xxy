...
def test_scheduler_iteration_details_serialization():
    ...
    outputs = EngineCoreOutputs(
        scheduler_stats=SchedulerStats(
            ...
            kv_retention_stats=KVRetentionStats(
                ...
                normal_blocks=4,
                resumed_blocks=5,
                high_priority_blocks=6,
                avoided_evictions=4,
                fallback_blocks=5,
            ),
            kv_admission_stats=KVAdmissionStats(
                selection_calls=1,
                candidates=2,
                candidate_probes=3,
                candidates_with_hits=4,
                reordered=5,
                aged_selections=6,
                selected_cached_tokens=7,
                admitted=8,
            ...
            kv_preemption_stats=KVPreemptionStats(
                ...
                changed_selections=20,
                baseline_reclaimable_blocks=21,
                reclaimability_gain_blocks=22,
                selected_computed_tokens=23,
    ...
    assert decoded.scheduler_stats.kv_admission_stats == KVAdmissionStats(
        selection_calls=1,
        candidates=2,
        candidate_probes=3,
        candidates_with_hits=4,
